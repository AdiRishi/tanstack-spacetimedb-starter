---
name: spacetimedb
description: SpacetimeDB TypeScript SDK and server module development. Use when working with SpacetimeDB projects including table definitions, reducers, React integration, client bindings, and subscriptions. Triggers on SpacetimeDB-related code, imports from 'spacetimedb', 'spacetimedb/react', 'spacetimedb/server', or './module_bindings', table/reducer definitions, or questions about SpacetimeDB patterns and APIs.
---
